...
public class Comparison {
    public static List<Map<ChangedKey, Object>> form(
        ...
        for (String key : allKeys) {
            ...
            var isBothExistKey = fileData1.containsKey(key) && fileData2.containsKey(key);
            var isSameValue = Objects.equals(value1, value2);

            if (isBothExistKey && isSameValue) {
                map.put(ChangedKey.VALUE, value1);
                map.put(ChangedKey.STATUS, ChangedStatus.UNCHANGED);
            } else if (isBothExistKey && !isSameValue) {
